...
def set_seed(seed=42):
    ...
    #For deterministic PyTorch behavior
...
# We adjust the target in logarithmic steps
    ...
    def step(self, action):
        ...
        current_service_latency+=random.uniform(-0.01*current_service_latency, 0.01*current_service_latency) #5% schwankungen - simulate dynamic>
